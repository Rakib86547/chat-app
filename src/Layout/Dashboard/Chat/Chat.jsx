...
const Chat = () => {
    return (
        <div className="h-screen py-8 w-full overflow-y-auto bg-white border-l border-r  dark:bg-gray-900 dark:border-gray-700">
            <div>
                <div className="relative flex items-center mt-2 px-4">
                    <span className="absolute text-[22px] pl-3 text-[#878a92]">
                        <FiSearch className='df' />
                    </span>

                    <input type="text" placeholder="Search users for messages"
                        className="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus-visible:outline-none dark:focus:border-blue-300 " />
                </div>
            </div>
